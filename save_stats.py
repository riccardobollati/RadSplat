...
from submodules.gsplat.examples.utils import AppearanceOptModule, CameraOptModule, knn, rgb_to_sh, set_random_seed

from submodules.gsplat.gsplat import export_splats
from submodules.gsplat.gsplat.compression import PngCompression
from submodules.gsplat.gsplat.distributed import cli
from submodules.gsplat.gsplat.optimizers import SelectiveAdam
from submodules.gsplat.gsplat.rendering import rasterization
...
class Runner:
    ...
    def save_ckpt(self):
        ...
        print("Step: ", 0, stats)
        with open(
            f"{self.stats_dir}/train_step{0:04d}_rank{self.world_rank}.json",
            "w",
        ) as f:
            json.dump(stats, f)
